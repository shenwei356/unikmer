...
echo -e "K\tplain\tplain.gz\t.unik\t.unik.cpt\t.unik.ungz\t.unik.cpt.ungz\tplain.gz(%)\t.unik(%)\t.unik.cpt(%)\t.unik.ungz(%)\t.unik.cpt.ungz(%)"
seq 1 2 32 \
    | rush -v f=$f -k ' \
        unikmer count -k {} {f} -o {f}.k{}; \
        unikmer count -k {} {f} -o {f}.k{}.c -c; \
        unikmer count -k {} {f} -o {f}.k{}.C -C; \
        unikmer count -k {} {f} -o {f}.k{}.cC -c -C; \
